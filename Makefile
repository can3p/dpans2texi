...
pkgdatadir = $(datadir)/dpans2texi
pkglibdir = $(libdir)/dpans2texi
pkgincludedir = $(includedir)/dpans2texi
...
POST_UNINSTALL = :
subdir = .
DIST_COMMON = README $(am__configure_deps) $(ansicl_TEXINFOS) \
...
ACLOCAL = ${SHELL} /home/reb/local/dpans2texi-1.05/missing --run aclocal-1.10
AMTAR = ${SHELL} /home/reb/local/dpans2texi-1.05/missing --run tar
AUTOCONF = ${SHELL} /home/reb/local/dpans2texi-1.05/missing --run autoconf
AUTOHEADER = ${SHELL} /home/reb/local/dpans2texi-1.05/missing --run autoheader
AUTOMAKE = ${SHELL} /home/reb/local/dpans2texi-1.05/missing --run automake-1.10
AWK = mawk
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"dpans2texi\" -DPACKAGE_TARNAME=\"dpans2texi\" -DPACKAGE_VERSION=\"1.05\" -DPACKAGE_STRING=\"dpans2texi\ 1.05\" -DPACKAGE_BUGREPORT=\"jesper.harder@gmail.com\"
ECHO_C = 
ECHO_N = -n
ECHO_T = 
EMACS = emacs
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/reb/local/dpans2texi-1.05/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
PACKAGE = dpans2texi
PACKAGE_BUGREPORT = jesper.harder@gmail.com
PACKAGE_NAME = dpans2texi
PACKAGE_STRING = dpans2texi 1.05
PACKAGE_TARNAME = dpans2texi
...
STRIP = 
VERSION = 1.05
abs_builddir = /home/reb/local/dpans2texi-1.05
abs_srcdir = /home/reb/local/dpans2texi-1.05
abs_top_builddir = /home/reb/local/dpans2texi-1.05
abs_top_srcdir = /home/reb/local/dpans2texi-1.05
am__leading_dot = .
...
install_sh = $(SHELL) /home/reb/local/dpans2texi-1.05/install-sh
...
ansicl.dvi: ansicl.texi $(ansicl_TEXINFOS) 
	TEXINPUTS="$(am__TEXINFO_TEX_DIR)$(PATH_SEPARATOR)$$TEXINPUTS" \
	MAKEINFO='$(MAKEINFO) $(AM_MAKEINFOFLAGS) $(MAKEINFOFLAGS) -I $(srcdir)' \
	$(TEXI2DVI) -o $@ `test -f 'ansicl.texi' || echo '$(srcdir)/'`ansicl.texi

ansicl.pdf: ansicl.texi $(ansicl_TEXINFOS) 
	TEXINPUTS="$(am__TEXINFO_TEX_DIR)$(PATH_SEPARATOR)$$TEXINPUTS" \
	MAKEINFO='$(MAKEINFO) $(AM_MAKEINFOFLAGS) $(MAKEINFOFLAGS) -I $(srcdir)' \
	$(TEXI2PDF) -o $@ `test -f 'ansicl.texi' || echo '$(srcdir)/'`ansicl.texi

ansicl.html: ansicl.texi $(ansicl_TEXINFOS) 
	rm -rf $(@:.html=.htp)
	if $(MAKEINFOHTML) $(AM_MAKEINFOHTMLFLAGS) $(MAKEINFOFLAGS) -I $(srcdir) \
	 -o $(@:.html=.htp) `test -f 'ansicl.texi' || echo '$(srcdir)/'`ansicl.texi; \
	then \
	  rm -rf $@; \
...
mostlyclean-aminfo:
	-rm -rf ansicl.aux ansicl.cp ansicl.cps ansicl.fn ansicl.fns ansicl.ky \
...
check-am: all-am
check: check-am
all-am: Makefile $(INFO_DEPS) $(LISP) $(ELCFILES)
installdirs:
	for dir in "$(DESTDIR)$(infodir)" "$(DESTDIR)$(lispdir)"; do \
